...
\ques[][ques.remarkableequiv]{
  Are virtually $\theta$-strong cardinals, virtually $\theta$-supercompact cardinals and virtually $\theta$-Magidor-supercompact cardinals all equivalent, for any uncountable regular cardinal $\theta$?
}
...
\ques{
  What is the consistency strength of the generically setwise supercompact cardinals? The best upper bound is a virtually extendible, as given by Usuba's Theorem \ref{theo.usuba}, and a lower bound is the trivial faintly supercompact one. What if we require the cardinal to be inaccessible?
}

\ques{
  Is it consistent to have a faintly supercompact cardinal which is not generically setwise supercompact?
}
