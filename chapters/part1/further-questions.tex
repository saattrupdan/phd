...
\ques[][ques.prestrong-equivalence-k]{
  Assume there is no inner model with a woodin. Is every virtually $\theta$-measurable cardinal also virtually $\theta$-prestrong?
}
