...
\todo[inline]{Short introduction to what will be covered and in which chapters we will use these facts and definitions}
...
\qtheo[xxx]{
  It is consistent, relative to the existence of a measurable cardinal\footnote{A much weaker assumption suffices, known as $0^\sharp$. See \cite{L} for more information.}, that every inaccessible, weakly compact, ineffable and completely ineffable cardinal remains inaccessible, weakly compact, ineffable and completely ineffable in $L$, respectively.
}
