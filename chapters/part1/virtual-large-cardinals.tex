...
\defi[][defi.strongsc]{
  \todo[inline]{Change the names of these?}
...
\theo[N.][theo.virtchar]{
  \todo[inline]{Replace the superstrong by rank-into-rank?}
...
\todo[inline]{Mention and reference what is currently known about Berkeley cardinals and their variants.}
