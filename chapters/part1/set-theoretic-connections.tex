...
Note that if the generic measure $\mu$ is $V$-normal then $\I(\mathbb P,\dot\mu)$ is also normal.
...
\begin{comment}
The following is an unpublished result due to Foreman.
...
We next prove the following, which is an improved version of an unpublished result by Foreman.
