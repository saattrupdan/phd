...
\theo[\cite{Schindler} and \cite{Schindler2}]{
  The following are equiconsistent:
  \begin{itemize}
    \item There exists a virtually supercompact cardinal;
    \item The theory of $L(\mathbb R)$ cannot be changed by proper forcing;
    \item The theory of $L(\mathbb R)$ cannot be changed by semi-proper forcing.
  \end{itemize}
}

\theo[\cite{WilsonVopenka}]{
  The following are equiconsistent:
  \begin{itemize}
    \item There exists a virtually Vop\v enka cardinal;
    \item $\zf+\godel{\text{$\b\Sigma^1_2$ is the class of all $\omega_1$-Suslin sets}} + \Theta = \aleph_2$.
  \end{itemize}
}

\theo[\cite{SchindlerWilson}]{
  The following are equiconsistent:
  \begin{itemize}
    \item There exists a virtually Shelah cardinal;
    \item $\zf+\godel{\text{every universally Baire set of reals has the perfect set property}}$.
  \end{itemize}
}
